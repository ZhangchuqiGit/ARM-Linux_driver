...
debug_echo "./Configure linux-armv4 shared no-asm '\'
    --prefix=${myprefix} '\'
    CROSS_COMPILE=${KERNELDIR} "
# 述配置中" linux-armv4 "表示 32 位 ARM 凭条，并没有"linux-armv7"这个选项。
# CROSS_COMPILE 用于指定交叉编译器。配置成功以后会生成 Makefile
# -prefix=编译输出路径
